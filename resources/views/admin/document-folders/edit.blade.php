...
@section('title', 'Edit Folder Dokumen')
...
<div class="max-w-4xl mx-auto pb-20">
    <div class="space-y-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-black text-white italic tracking-tight font-outfit uppercase">Edit Folder</h2>
                <p class="text-slate-400 text-sm font-medium uppercase tracking-widest mt-1">Perbarui informasi pengelompokan berkas</p>
            </div>
        </div>

        <div class="bg-slate-900/50 backdrop-blur-2xl rounded-[2.5rem] border border-white/5 shadow-2xl overflow-hidden">
            <form action="{{ route('admin.document-folders.update', $documentFolder) }}" method="POST" class="p-8 md:p-12 space-y-10">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-3">
                    ...
                    <input id="name" name="name" type="text" required value="{{ old('name', $documentFolder->name) }}"
                ...
                <div class="space-y-3">
                    ...
                    <textarea id="description" name="description" rows="4" 
                        ...
                        placeholder="Berikan sedikit penjelasan mengenai kelompok dokumen ini...">{{ old('description', $documentFolder->description) }}</textarea>
                </div>
