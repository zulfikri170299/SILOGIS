...
<div class="mb-8">
    ...
    <h2 class="text-2xl font-black text-white font-outfit uppercase tracking-tight">Tambah Bagian</h2>
</div>

<div class="max-w-2xl bg-slate-900/50 backdrop-blur-2xl rounded-3xl border border-white/5 shadow-2xl p-8">
    <form action="{{ route('admin.bagians.store') }}" method="POST" class="space-y-6">
        @csrf
