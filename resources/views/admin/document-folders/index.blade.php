        ...
        <div class="group bg-slate-900/50 backdrop-blur-2xl rounded-[2.5rem] p-8 border border-white/5 hover:border-brand-primary transition-all duration-500">
            <div class="flex items-start justify-between mb-8">
                ...
                <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <form action="{{ route('admin.document-folders.destroy', $folder) }}" method="POST" onsubmit="return confirmDelete(this, 'Hapus folder ini? Dokumen di dalamnya tidak akan terhapus namun akan kehilangan kelompok foldernya.');">
                        @csrf
                        @method('DELETE')
