                ...
                @forelse($reports as $item)
                    <tr class="hover:bg-slate-800/30 transition-colors">
                        ...
                        <td class="px-4 py-4 sm:px-6 text-right whitespace-nowrap">
                            ...
                            <form action="{{ route('admin.bws.destroy', $item) }}" method="POST" class="inline-block" onsubmit="return confirmDelete(this, 'Apakah Anda yakin ingin menghapus laporan ini?');">
                                @csrf
                                @method('DELETE')
